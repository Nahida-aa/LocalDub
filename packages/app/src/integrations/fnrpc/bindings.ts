...
export type Value =
  ...
  | ({
      Number:
        | ({ f64: number | null } & { i64?: never; u64?: never })
        | ({ i64: bigint } & { f64?: never; u64?: never })
        | ({ u64: bigint } & { f64?: never; i64?: never });
...
export type Procedures = {
  ...
  start_new_task: {
    kind: "mutate";
    method: "POST";
    input: [string, string, string | null, string | null];
    output: null;
    error: RpcErr;
  };
};
