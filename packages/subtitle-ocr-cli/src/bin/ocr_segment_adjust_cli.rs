...
use subtitle_ocr::{
    FrameResult, OcrBoxResult, OcrSegmentAdjustArgs, OcrSegmentWithAdjust, SubtitleSegment, YStats,
    compute_box_y_stats, ocr_segment_adjust,
};
use tracing::info;
...
fn main() -> Result<()> {
    ...
    let result: Vec<OcrSegmentWithAdjust> = ocr_segment_adjust(
        &segments,
        &frames,
        &y_stats,
        video_height,
