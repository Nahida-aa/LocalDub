...
export type OcrSegmentFilterData =
  | OcrSegmentFilterData_Serialize
  | OcrSegmentFilterData_Deserialize;
...
export type OcrSegmentFilterResult =
  | OcrSegmentFilterResult_Serialize
  | OcrSegmentFilterResult_Deserialize;
...
/**  应用置信度调整后的字幕段。 */
export type OcrSegmentWithAdjust =
  | OcrSegmentWithAdjust_Serialize
  | OcrSegmentWithAdjust_Deserialize;
